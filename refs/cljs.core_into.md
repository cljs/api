...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:2923-2931](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L2923-L2931)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn into\n  [to from]\n  (if-not (nil? to)\n    (if (satisfies? IEditableCollection to false)\n      (persistent! (reduce -conj! (transient to) from))\n      (reduce -conj to from))\n    (reduce conj () from)))",
          ...
          :lines [2923 2931],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L2923-L2931"},
