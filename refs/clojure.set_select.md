...
└── src
    └── cljs
        └── clojure
            └── <ins>[set.cljs:61-65](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L61-L65)</ins>
</pre>
...
{:ns "clojure.set",
 ...
 :source {:code "(defn select\n  [pred xset]\n    (reduce (fn [s k] (if (pred k) s (disj s k)))\n            xset xset))",
          ...
          :lines [61 65],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L61-L65"},
