...
└── src
    └── cljs
        └── clojure
            └── <ins>[string.cljs:111-114](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/string.cljs#L111-L114)</ins>
</pre>
...
{:ns "clojure.string",
 ...
 :source {:code "(defn triml\n    [s]\n    (gstring/trimLeft s))",
          ...
          :lines [111 114],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/string.cljs#L111-L114"},
