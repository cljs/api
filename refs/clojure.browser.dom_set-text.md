...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[dom.cljs:124-129](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/dom.cljs#L124-L129)</ins>
</pre>
...
{:full-name "clojure.browser.dom/set-text",
 ...
 :source {:code "(defn set-text\n  [e s]\n  (gdom/setTextContent (ensure-element e) s))",
          ...
          :lines [124 129],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/dom.cljs#L124-L129"},
