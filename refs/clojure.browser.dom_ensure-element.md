...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[dom.cljs:107-112](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/dom.cljs#L107-L112)</ins>
</pre>
...
{:full-name "clojure.browser.dom/ensure-element",
 ...
 :source {:code "(defn ensure-element\n  [e]\n  (cond (keyword? e) (get-element e)\n        (string? e) (html->dom e)\n        :else e))",
          ...
          :lines [107 112],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/dom.cljs#L107-L112"},
