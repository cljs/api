...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[dom.cljs:147-149](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/dom.cljs#L147-L149)</ins>
</pre>
...
{:full-name "clojure.browser.dom/click-element",
 ...
 :source {:code "(defn click-element\n  [e]\n  (.click (ensure-element e) ()))",
          ...
          :lines [147 149],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/dom.cljs#L147-L149"},
