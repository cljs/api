...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:2355-2363](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L2355-L2363)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn list*\n  ([args] (seq args))\n  ([a args] (cons a args))\n  ([a b args] (cons a (cons b args)))\n  ([a b c args] (cons a (cons b (cons c args))))\n  ([a b c d & more]\n     (cons a (cons b (cons c (cons d (spread more)))))))",
          ...
          :lines [2355 2363],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L2355-L2363"},
