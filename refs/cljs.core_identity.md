...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:2183-2183](https://github.com/clojure/clojurescript/blob/r1443/src/cljs/cljs/core.cljs#L2183-L2183)</ins>
</pre>
...
{:full-name "cljs.core/identity",
 ...
 :source {:code "(defn identity [x] x)",
          ...
          :lines [2183 2183],
          :link "https://github.com/clojure/clojurescript/blob/r1443/src/cljs/cljs/core.cljs#L2183-L2183"},
