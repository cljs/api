...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:1045-1050](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L1045-L1050)</ins>
</pre>
...
{:full-name "cljs.core/hash",
 ...
 :source {:code "(defn hash\n  ([o] (hash o true))\n  ([o ^boolean check-cache]\n     (if (and ^boolean (goog/isString o) check-cache)\n       (check-string-hash-cache o)\n       (-hash o))))",
          ...
          :lines [1045 1050],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L1045-L1050"},
