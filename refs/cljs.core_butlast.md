...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:6144-6148](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6144-L6148)</ins>
</pre>
...
{:full-name "cljs.core/butlast",
 ...
 :source {:code "(defn butlast [s]\n  (loop [ret [] s s]\n    (if (next s)\n      (recur (conj ret (first s)) (next s))\n      (seq ret))))",
          ...
          :lines [6144 6148],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6144-L6148"},
