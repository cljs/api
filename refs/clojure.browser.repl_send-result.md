...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[repl.cljs:38-39](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/repl.cljs#L38-L39)</ins>
</pre>
...
{:full-name "clojure.browser.repl/send-result",
 ...
 :source {:code "(defn send-result [connection url data]\n  (net/transmit connection url \"POST\" data nil 0))",
          ...
          :lines [38 39],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/repl.cljs#L38-L39"},
