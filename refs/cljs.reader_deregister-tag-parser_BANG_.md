...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:552-557](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/reader.cljs#L552-L557)</ins>
</pre>
...
{:full-name "cljs.reader/deregister-tag-parser!",
 ...
 :source {:code "(defn deregister-tag-parser!\n  [tag]\n  (let [tag (str tag)\n        old-parser (get @*tag-table* tag)]\n    (swap! *tag-table* dissoc tag)\n    old-parser))",
          ...
          :lines [552 557],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/reader.cljs#L552-L557"},
