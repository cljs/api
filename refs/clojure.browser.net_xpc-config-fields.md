...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[net.cljs:75-81](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/net.cljs#L75-L81)</ins>
</pre>
...
{:full-name "clojure.browser.net/xpc-config-fields",
 ...
 :source {:code "(def xpc-config-fields\n  (into {}\n        (map\n         (fn [[k v]]\n           [(keyword (. k (toLowerCase)))\n            v])\n         (js->clj goog.net.xpc.CfgFields))))",
          ...
          :lines [75 81],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/net.cljs#L75-L81"},
