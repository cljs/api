...
{:return-type number,
 ...
 :source {:code "(defn ^number unchecked-float [x] x)",
          ...
          :lines [2450],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2450"},
 :extra-sources [{:code "(core/defmacro unchecked-float [x] x)",
                  ...
                  :lines [963],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L963"}],
