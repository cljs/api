...
{:return-type number,
 ...
 :source {:code "(defn ^number unchecked-float [x] x)",
          ...
          :lines [2444],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2444"},
 :extra-sources [{:code "(core/defmacro unchecked-float [x] x)",
                  ...
                  :lines [960],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L960"}],
