...
{:description "Returns true if `x` is the value true, false otherwise.",
 ...
 :source {:code "(defn ^boolean true?\n  [x] (cljs.core/true? x))",
          ...
          :lines [2063 2065],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2063-L2065"},
 :extra-sources [{:code "(core/defmacro true? [x]\n  (bool-expr (core/list 'js* \"~{} === true\" x)))",
                  ...
                  :lines [890 891],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L890-L891"}],
 :usage ["(true? x)"],
