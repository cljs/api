...
{:description "Returns true if `x` is the value true, false otherwise.",
 ...
 :source {:code "(defn ^boolean true?\n  [x] (cljs.core/true? x))",
          ...
          :lines [2063 2065],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2063-L2065"},
 :extra-sources [{:code "(core/defmacro true? [x]\n  (bool-expr (core/list 'js* \"~{} === true\" x)))",
                  ...
                  :lines [906 907],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L906-L907"}],
 :usage ["(true? x)"],
