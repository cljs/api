...
<samp>(unchecked-inc-int x)</samp><br>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn unchecked-inc-int [x]\n  (cljs.core/unchecked-inc-int x))",
          ...
          :lines [2487 2488],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2487-L2488"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric unchecked-inc-int\n  ([x] `(inc ~x)))",
                  ...
                  :lines [1000 1001],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L1000-L1001"}],
 :usage ["(unchecked-inc-int x)"],
 :full-name "cljs.core/unchecked-inc-int",
 :cljsdoc-url "https://github.com/cljsinfo/cljs-api-docs/blob/master/cljsdoc/cljs.core/unchecked-inc-int.cljsdoc"}
