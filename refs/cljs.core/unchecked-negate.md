...
{:ns "cljs.core",
 ...
 :source {:code "(defn unchecked-negate [x]\n  (cljs.core/unchecked-negate x))",
          ...
          :lines [2504 2505],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2504-L2505"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric unchecked-negate\n  ([x] `(- ~x)))",
                  ...
                  :lines [993 994],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L993-L994"}],
