...
{:return-type number,
 ...
 :source {:code "(defn ^number byte [x] x)",
          ...
          :lines [2433],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2433"},
 :extra-sources [{:code "(core/defmacro byte [x] x)",
                  ...
                  :lines [971],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L971"}],
 :usage ["(byte x)"],
