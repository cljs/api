...
{:return-type number,
 ...
 :source {:code "(defn ^number byte [x] x)",
          ...
          :lines [2433],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2433"},
 :extra-sources [{:code "(core/defmacro byte [x] x)",
                  ...
                  :lines [955],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L955"}],
 :usage ["(byte x)"],
