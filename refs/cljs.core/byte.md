...
{:return-type number,
 ...
 :source {:code "(defn ^number byte [x] x)",
          ...
          :lines [2427],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2427"},
 :extra-sources [{:code "(core/defmacro byte [x] x)",
                  ...
                  :lines [952],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L952"}],
 :usage ["(byte x)"],
