...
{:description "Bitwise complement.  Same as `~x` in JavaScript.",
 ...
 :source {:code "(defn bit-not\n  [x] (cljs.core/bit-not x))",
          ...
          :lines [2613 2615],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2613-L2615"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric bit-not [x]\n  (core/list 'js* \"(~ ~{})\" x))",
                  ...
                  :lines [1081 1082],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L1081-L1082"}],
 :usage ["(bit-not x)"],
 :examples [{:id "d4c5e3",
