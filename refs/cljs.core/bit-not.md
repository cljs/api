...
{:description "Bitwise complement.  Same as `~x` in JavaScript.",
 ...
 :source {:code "(defn bit-not\n  [x] (cljs.core/bit-not x))",
          ...
          :lines [2619 2621],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2619-L2621"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric bit-not [x]\n  (core/list 'js* \"(~ ~{})\" x))",
                  ...
                  :lines [1084 1085],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L1084-L1085"}],
 :usage ["(bit-not x)"],
 :examples [{:id "d4c5e3",
