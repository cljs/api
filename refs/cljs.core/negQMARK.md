...
{:description "Returns true if `n` is less than 0, false otherwise.",
 ...
 :source {:code "(defn ^boolean neg?\n  [x] (cljs.core/neg? x))",
          ...
          :lines [2672 2674],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2672-L2674"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric neg? [x]\n  `(< ~x 0))",
                  ...
                  :lines [1063 1064],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L1063-L1064"}],
 :usage ["(neg? n)"],
