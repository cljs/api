...
{:description "Returns true if `n` is less than 0, false otherwise.",
 ...
 :source {:code "(defn ^boolean neg?\n  [x] (cljs.core/neg? x))",
          ...
          :lines [2678 2680],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2678-L2680"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric neg? [x]\n  `(< ~x 0))",
                  ...
                  :lines [1082 1083],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L1082-L1083"}],
 :usage ["(neg? n)"],
