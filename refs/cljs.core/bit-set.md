...
{:description "Set bit at index `n`.  Same as `x | (1 << y)` in JavaScript.",
 ...
 :source {:code "(defn bit-set\n  [x n]\n  (cljs.core/bit-set x n))",
          ...
          :lines [2623 2626],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2623-L2626"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric bit-set [x n]\n  (core/list 'js* \"(~{} | (1 << ~{}))\" x n))",
                  ...
                  :lines [1132 1133],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L1132-L1133"}],
 :usage ["(bit-set x n)"],
 :examples [{:id "6a8a49",
