...
{:description "Set bit at index `n`.  Same as `x | (1 << y)` in JavaScript.",
 ...
 :source {:code "(defn bit-set\n  [x n]\n  (cljs.core/bit-set x n))",
          ...
          :lines [2617 2620],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2617-L2620"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric bit-set [x n]\n  (core/list 'js* \"(~{} | (1 << ~{}))\" x n))",
                  ...
                  :lines [1129 1130],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L1129-L1130"}],
 :usage ["(bit-set x n)"],
 :examples [{:id "6a8a49",
