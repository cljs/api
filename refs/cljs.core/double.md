...
{:return-type number,
 ...
 :source {:code "(defn ^number double [x] x)",
          ...
          :lines [2439],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2439"},
 :extra-sources [{:code "(core/defmacro double [x] x)",
                  ...
                  :lines [955],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L955"}],
 :usage ["(double x)"],
