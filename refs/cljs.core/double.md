...
{:return-type number,
 ...
 :source {:code "(defn ^number double [x] x)",
          ...
          :lines [2445],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2445"},
 :extra-sources [{:code "(core/defmacro double [x] x)",
                  ...
                  :lines [958],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L958"}],
 :usage ["(double x)"],
