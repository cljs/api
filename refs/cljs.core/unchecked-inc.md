...
{:ns "cljs.core",
 ...
 :source {:code "(defn unchecked-inc [x]\n  (cljs.core/unchecked-inc x))",
          ...
          :lines [2484 2485],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2484-L2485"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric unchecked-inc\n  ([x] `(inc ~x)))",
                  ...
                  :lines [997 998],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L997-L998"}],
