...
{:description "Returns a number one greater than `x`.",
 ...
 :source {:code "(defn inc\n  [x] (cljs.core/+ x 1))",
          ...
          :lines [1277 1279],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L1277-L1279"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric inc [x]\n  `(+ ~x 1))",
                  ...
                  :lines [1054 1055],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L1054-L1055"}],
 :usage ["(inc x)"],
