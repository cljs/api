...
{:description "Returns a number one greater than `x`.",
 ...
 :source {:code "(defn inc\n  [x] (cljs.core/+ x 1))",
          ...
          :lines [1283 1285],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L1283-L1285"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric inc [x]\n  `(+ ~x 1))",
                  ...
                  :lines [1073 1074],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L1073-L1074"}],
 :usage ["(inc x)"],
