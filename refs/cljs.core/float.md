...
{:return-type number,
 ...
 :source {:code "(defn ^number float [x] x)",
          ...
          :lines [2438],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2438"},
 :extra-sources [{:code "(core/defmacro float [x] x)",
                  ...
                  :lines [954],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L954"}],
 :usage ["(float x)"],
