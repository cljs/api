...
{:return-type number,
 ...
 :source {:code "(defn ^number float [x] x)",
          ...
          :lines [2444],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2444"},
 :extra-sources [{:code "(core/defmacro float [x] x)",
                  ...
                  :lines [957],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L957"}],
 :usage ["(float x)"],
