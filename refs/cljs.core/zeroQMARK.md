...
{:description "Returns true if `n` is 0, false otherwise.",
 ...
 :source {:code "(defn ^boolean zero?\n  [x]\n  (cljs.core/zero? x))",
          ...
          :lines [2673 2676],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2673-L2676"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric zero? [x]\n  `(== ~x 0))",
                  ...
                  :lines [1060 1061],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L1060-L1061"}],
 :usage ["(zero? n)"],
