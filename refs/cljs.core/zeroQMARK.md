...
{:description "Returns true if `n` is 0, false otherwise.",
 ...
 :source {:code "(defn ^boolean zero?\n  [x]\n  (cljs.core/zero? x))",
          ...
          :lines [2673 2676],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2673-L2676"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric zero? [x]\n  `(== ~x 0))",
                  ...
                  :lines [1076 1077],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L1076-L1077"}],
 :usage ["(zero? n)"],
