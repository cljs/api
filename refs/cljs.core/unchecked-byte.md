...
{:return-type number,
 ...
 :source {:code "(defn ^number unchecked-byte [x] x)",
          ...
          :lines [2447],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2447"},
 :extra-sources [{:code "(core/defmacro unchecked-byte [x] x)",
                  ...
                  :lines [976],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L976"}],
