...
{:description "Returns true if `n` is greater than 0, false otherwise.",
 ...
 :source {:code "(defn ^boolean pos?\n  [x] (cljs.core/pos? x))",
          ...
          :lines [2669 2671],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2669-L2671"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric pos? [x]\n  `(> ~x 0))",
                  ...
                  :lines [1079 1080],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L1079-L1080"}],
 :usage ["(pos? n)"],
