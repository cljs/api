...
{:return-type boolean,
 ...
 :source {:code "(defn ^boolean keyword?\n  [x]\n  (instance? Keyword x))",
          ...
          :lines [3053 3056],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L3053-L3056"},
 :extra-sources [{:code "(core/defmacro keyword? [x]\n  (bool-expr `(instance? Keyword ~x)))",
                  ...
                  :lines [928 929],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L928-L929"}],
 :usage ["(keyword? x)"],
