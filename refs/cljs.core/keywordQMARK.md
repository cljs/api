...
{:return-type boolean,
 ...
 :source {:code "(defn ^boolean keyword?\n  [x]\n  (instance? Keyword x))",
          ...
          :lines [3059 3062],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L3059-L3062"},
 :extra-sources [{:code "(core/defmacro keyword? [x]\n  (bool-expr `(instance? Keyword ~x)))",
                  ...
                  :lines [947 948],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L947-L948"}],
 :usage ["(keyword? x)"],
