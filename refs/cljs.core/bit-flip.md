...
{:description "Flip bit at index `n`.  Same as `x ^ (1 << y)` in JavaScript.",
 ...
 :source {:code "(defn bit-flip\n  [x n]\n  (cljs.core/bit-flip x n))",
          ...
          :lines [2614 2617],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2614-L2617"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric bit-flip [x n]\n  (core/list 'js* \"(~{} ^ (1 << ~{}))\" x n))",
                  ...
                  :lines [1114 1115],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L1114-L1115"}],
 :usage ["(bit-flip x n)"],
 :examples [{:id "5d7ee0",
