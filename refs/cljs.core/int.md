...
{:description "Coerces `x` to an integer by stripping decimal places.",
 ...
 :source {:code "(defn int\n  [x]\n  (bit-or x 0))",
          ...
          :lines [2534 2537],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2534-L2537"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric int [x]\n  `(bit-or ~x 0))",
                  ...
                  :lines [1116 1117],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L1116-L1117"}],
 :usage ["(int x)"],
