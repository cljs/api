...
{:description "Coerces `x` to an integer by stripping decimal places.",
 ...
 :source {:code "(defn int\n  [x]\n  (bit-or x 0))",
          ...
          :lines [2534 2537],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2534-L2537"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric int [x]\n  `(bit-or ~x 0))",
                  ...
                  :lines [1100 1101],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L1100-L1101"}],
 :usage ["(int x)"],
