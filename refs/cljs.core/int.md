...
{:description "Coerces `x` to an integer by stripping decimal places.",
 ...
 :source {:code "(defn int\n  [x]\n  (bit-or x 0))",
          ...
          :lines [2528 2531],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2528-L2531"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric int [x]\n  `(bit-or ~x 0))",
                  ...
                  :lines [1097 1098],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L1097-L1098"}],
 :usage ["(int x)"],
 :full-name "cljs.core/int",
 :docstring "Coerce to int by stripping decimal places.",
 :cljsdoc-url "https://github.com/cljsinfo/cljs-api-docs/blob/master/cljsdoc/cljs.core/int.cljsdoc"}
