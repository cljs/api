...
{:return-type number,
 ...
 :source {:code "(defn ^number unchecked-short [x] x)",
          ...
          :lines [2449],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2449"},
 :extra-sources [{:code "(core/defmacro unchecked-short [x] x)",
                  ...
                  :lines [978],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L978"}],
