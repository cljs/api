...
{:description "Clear bit at index `n`.  Same as `x & ~(1 << y)` in JavaScript.",
 ...
 :source {:code "(defn bit-clear\n  [x n]\n  (cljs.core/bit-clear x n))",
          ...
          :lines [2603 2606],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2603-L2606"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric bit-clear [x n]\n  (core/list 'js* \"(~{} & ~(1 << ~{}))\" x n))",
                  ...
                  :lines [1108 1109],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L1108-L1109"}],
 :usage ["(bit-clear x n)"],
 :examples [{:id "0f6748",
