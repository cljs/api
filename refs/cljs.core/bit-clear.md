...
{:description "Clear bit at index `n`.  Same as `x & ~(1 << y)` in JavaScript.",
 ...
 :source {:code "(defn bit-clear\n  [x n]\n  (cljs.core/bit-clear x n))",
          ...
          :lines [2609 2612],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2609-L2612"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric bit-clear [x n]\n  (core/list 'js* \"(~{} & ~(1 << ~{}))\" x n))",
                  ...
                  :lines [1111 1112],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L1111-L1112"}],
 :usage ["(bit-clear x n)"],
 :examples [{:id "0f6748",
