...
{:description "Returns true if `n` is a number, false otherwise.",
 ...
 :source {:code "(defn ^boolean number?\n  [x]\n  (cljs.core/number? x))",
          ...
          :lines [198 201],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L198-L201"},
 :extra-sources [{:code "(core/defmacro number? [x]\n  (bool-expr (core/list 'js* \"typeof ~{} === 'number'\" x)))",
                  ...
                  :lines [925 926],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L925-L926"}],
 :usage ["(number? n)"],
