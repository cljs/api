...
{:description "Returns a number one less than `x`.",
 ...
 :source {:code "(defn dec\n  [x] (- x 1))",
          ...
          :lines [2415 2417],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2415-L2417"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric dec [x]\n  `(- ~x 1))",
                  ...
                  :lines [1070 1071],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L1070-L1071"}],
 :usage ["(dec x)"],
 :full-name "cljs.core/dec",
 :docstring "Returns a number one less than num.",
 :cljsdoc-url "https://github.com/cljsinfo/cljs-api-docs/blob/master/cljsdoc/cljs.core/dec.cljsdoc"}
