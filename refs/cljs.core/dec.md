...
{:description "Returns a number one less than `x`.",
 ...
 :source {:code "(defn dec\n  [x] (- x 1))",
          ...
          :lines [2415 2417],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2415-L2417"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric dec [x]\n  `(- ~x 1))",
                  ...
                  :lines [1054 1055],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L1054-L1055"}],
 :usage ["(dec x)"],
