...
{:return-type boolean,
 ...
 :source {:code "(defn ^boolean symbol?\n  [x]\n  (instance? Symbol x))",
          ...
          :lines [927 930],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L927-L930"},
 :extra-sources [{:code "(core/defmacro symbol? [x]\n  (bool-expr `(instance? Symbol ~x)))",
                  ...
                  :lines [928 929],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L928-L929"}],
 :usage ["(symbol? x)"],
