...
{:return-type number,
 ...
 :source {:code "(defn ^number unchecked-double [x] x)",
          ...
          :lines [2445],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2445"},
 :extra-sources [{:code "(core/defmacro unchecked-double [x] x)",
                  ...
                  :lines [961],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L961"}],
