...
{:return-type number,
 ...
 :source {:code "(defn ^number unchecked-double [x] x)",
          ...
          :lines [2451],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2451"},
 :extra-sources [{:code "(core/defmacro unchecked-double [x] x)",
                  ...
                  :lines [964],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L964"}],
