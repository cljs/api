...
{:return-type number,
 ...
 :source {:code "(defn ^number unchecked-char [x] x)",
          ...
          :lines [2448],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2448"},
 :extra-sources [{:code "(core/defmacro unchecked-char [x] x)",
                  ...
                  :lines [961],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L961"}],
