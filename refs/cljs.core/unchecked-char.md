...
{:return-type number,
 ...
 :source {:code "(defn ^number unchecked-char [x] x)",
          ...
          :lines [2442],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2442"},
 :extra-sources [{:code "(core/defmacro unchecked-char [x] x)",
                  ...
                  :lines [958],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L958"}],
