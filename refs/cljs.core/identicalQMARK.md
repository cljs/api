...
{:description "Returns true if `x` and `y` are the same object, false otherwise.",
 ...
 :source {:code "(defn ^boolean identical?\n  [x y]\n  (cljs.core/identical? x y))",
          ...
          :lines [181 184],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L181-L184"},
 :extra-sources [{:code "(core/defmacro identical? [a b]\n  (bool-expr (core/list 'js* \"(~{} === ~{})\" a b)))",
                  ...
                  :lines [913 914],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L913-L914"}],
 :usage ["(identical? x y)"],
