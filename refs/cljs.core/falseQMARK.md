...
{:description "Returns true if `x` is the value false, false otherwise.",
 ...
 :source {:code "(defn ^boolean false?\n  [x] (cljs.core/false? x))",
          ...
          :lines [2059 2061],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2059-L2061"},
 :extra-sources [{:code "(core/defmacro false? [x]\n  (bool-expr (core/list 'js* \"~{} === false\" x)))",
                  ...
                  :lines [893 894],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L893-L894"}],
 :usage ["(false? x)"],
