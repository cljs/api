...
{:return-type number,
 ...
 :source {:code "(defn ^number short [x] x)",
          ...
          :lines [2443],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2443"},
 :extra-sources [{:code "(core/defmacro short [x] x)",
                  ...
                  :lines [956],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L956"}],
 :usage ["(short x)"],
