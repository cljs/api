...
{:return-type number,
 ...
 :source {:code "(defn ^number short [x] x)",
          ...
          :lines [2437],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/cljs/core.cljs#L2437"},
 :extra-sources [{:code "(core/defmacro short [x] x)",
                  ...
                  :lines [953],
                  :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/clojure/cljs/core.cljc#L953"}],
 :usage ["(short x)"],
