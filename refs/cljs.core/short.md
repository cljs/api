...
{:return-type number,
 ...
 :source {:code "(defn ^number short [x] x)",
          ...
          :lines [2443],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/cljs/cljs/core.cljs#L2443"},
 :extra-sources [{:code "(core/defmacro short [x] x)",
                  ...
                  :lines [972],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/core.cljc#L972"}],
 :usage ["(short x)"],
