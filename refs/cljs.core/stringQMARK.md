...
{:description "Returns true if `x` is a string, false otherwise.",
 ...
 :source {:code "(defn ^boolean string?\n  [x]\n  (goog/isString x))",
          ...
          :lines [222 225],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L222-L225"},
 :extra-sources [{:code "(core/defmacro string? [x]\n  (bool-expr (core/list 'js* \"typeof ~{} === 'string'\" x)))",
                  ...
                  :lines [896 897],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L896-L897"}],
 :usage ["(string? x)"],
