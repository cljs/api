...
{:description "Bitwise shift left `n` bits.  Same as `x << n` in JavaScript.",
 ...
 :source {:code "(defn bit-shift-left\n  [x n] (cljs.core/bit-shift-left x n))",
          ...
          :lines [2633 2635],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/cljs/cljs/core.cljs#L2633-L2635"},
 :extra-sources [{:code "(core/defmacro ^::ana/numeric bit-shift-left [x n]\n  (core/list 'js* \"(~{} << ~{})\" x n))",
                  ...
                  :lines [1120 1121],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/core.cljc#L1120-L1121"}],
