...
{:ns "cljs.repl.rhino",
 ...
 :source {:code "(defmulti stacktrace class)",
          ...
          :lines [50],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/repl/rhino.clj#L50"},
 :extra-sources ({:code "(defmethod stacktrace :default [e]\n  (apply str\n    (interpose \"\\n\"\n      (map #(str \"        \" (.toString %))\n        (.getStackTrace e)))))",
                  ...
                  :filename "src/main/clojure/cljs/repl/rhino.clj",
                  :lines [52 56],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/repl/rhino.clj#L52-L56"}
                 {:code "(defmethod stacktrace RhinoException [^RhinoException e]\n  (.getScriptStackTrace e))",
                  ...
                  :filename "src/main/clojure/cljs/repl/rhino.clj",
                  :lines [58 59],
                  :url "https://github.com/clojure/clojurescript/blob/r1.9.14/src/main/clojure/cljs/repl/rhino.clj#L58-L59"}),
