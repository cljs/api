...
{:ns "cljs.repl",
 ...
 :source {:code "(def ^:dynamic *cljs-verbose* false)",
          ...
          :lines [37],
          :url "https://github.com/clojure/clojurescript/blob/r1.9.36/src/main/clojure/cljs/repl.cljc#L37"},
 :full-name "cljs.repl/*cljs-verbose*",
 :cljsdoc-url "https://github.com/cljsinfo/cljs-api-docs/blob/master/cljsdoc/cljs.repl/STARcljs-verboseSTAR.cljsdoc"}
