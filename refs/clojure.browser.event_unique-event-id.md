...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:92-92](https://github.com/clojure/clojurescript/blob/r1449/src/cljs/clojure/browser/event.cljs#L92-L92)</ins>
</pre>
...
{:full-name "clojure.browser.event/unique-event-id",
 ...
 :source {:code "(defn unique-event-id [event-type])",
          ...
          :lines [92 92],
          :link "https://github.com/clojure/clojurescript/blob/r1449/src/cljs/clojure/browser/event.cljs#L92-L92"},
