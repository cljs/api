...
└── src
    └── cljs
        └── clojure
            └── <ins>[set.cljs:132-136](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L132-L136)</ins>
</pre>
...
{:ns "clojure.set",
 ...
 :source {:code "(defn subset? \n  [set1 set2]\n  (and (<= (count set1) (count set2))\n       (every? #(contains? set2 %) set1)))",
          ...
          :lines [132 136],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L132-L136"},
