...
└── src
    └── cljs
        └── clojure
            └── <ins>[set.cljs:88-96](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L88-L96)</ins>
</pre>
...
{:ns "clojure.set",
 ...
 :source {:code "(defn index\n  [xrel ks]\n    (reduce\n     (fn [m x]\n       (let [ik (select-keys x ks)]\n         (assoc m ik (conj (get m ik #{}) x))))\n     {} xrel))",
          ...
          :lines [88 96],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L88-L96"},
