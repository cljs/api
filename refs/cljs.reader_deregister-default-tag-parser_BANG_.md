...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:565-569](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/reader.cljs#L565-L569)</ins>
</pre>
...
{:full-name "cljs.reader/deregister-default-tag-parser!",
 ...
 :source {:code "(defn deregister-default-tag-parser!\n  []\n  (let [old-parser @*default-data-reader-fn*]\n    (swap! *default-data-reader-fn* (fn [_] nil))\n    old-parser))",
          ...
          :lines [565 569],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/reader.cljs#L565-L569"},
