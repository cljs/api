...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:3462-3471](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L3462-L3471)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn subvec\n  ([v start]\n     (subvec v start (count v)))\n  ([v start end]\n     (build-subvec nil v start end nil)))",
          ...
          :lines [3462 3471],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L3462-L3471"},
