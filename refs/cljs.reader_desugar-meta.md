...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:343-349](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/reader.cljs#L343-L349)</ins>
</pre>
...
{:full-name "cljs.reader/desugar-meta",
 ...
 :source {:code "(defn desugar-meta\n  [f]\n  (cond\n   (symbol? f) {:tag f}\n   (string? f) {:tag f}\n   (keyword? f) {f true}\n   :else f))",
          ...
          :lines [343 349],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/reader.cljs#L343-L349"},
