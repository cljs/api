...
└── src
    └── clj
        └── cljs
            └── <ins>[core.clj:1194-1207](https://github.com/clojure/clojurescript/blob/r1834/src/clj/cljs/core.clj#L1194-L1207)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defmacro amap\n  [a idx ret expr]\n  `(let [a# ~a\n         ~ret (aclone a#)]\n     (loop  [~idx 0]\n       (if (< ~idx  (alength a#))\n         (do\n           (aset ~ret ~idx ~expr)\n           (recur (inc ~idx)))\n         ~ret))))",
          ...
          :lines [1194 1207],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/clj/cljs/core.clj#L1194-L1207"},
