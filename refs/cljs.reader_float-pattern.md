...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:97-97](https://github.com/clojure/clojurescript/blob/r971/src/cljs/cljs/reader.cljs#L97-L97)</ins>
</pre>
...
{:full-name "cljs.reader/float-pattern",
 ...
 :source {:code "(def float-pattern (re-pattern \"([-+]?[0-9]+(\\\\.[0-9]*)?([eE][-+]?[0-9]+)?)(M)?\"))",
          ...
          :lines [97 97],
          :link "https://github.com/clojure/clojurescript/blob/r971/src/cljs/cljs/reader.cljs#L97-L97"},
