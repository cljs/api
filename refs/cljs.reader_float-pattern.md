...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:101-101](https://github.com/clojure/clojurescript/blob/r1552/src/cljs/cljs/reader.cljs#L101-L101)</ins>
</pre>
...
{:full-name "cljs.reader/float-pattern",
 ...
 :source {:code "(def float-pattern (re-pattern \"([-+]?[0-9]+(\\\\.[0-9]*)?([eE][-+]?[0-9]+)?)(M)?\"))",
          ...
          :lines [101 101],
          :link "https://github.com/clojure/clojurescript/blob/r1552/src/cljs/cljs/reader.cljs#L101-L101"},
