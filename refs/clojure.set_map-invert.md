...
└── src
    └── cljs
        └── clojure
            └── <ins>[set.cljs:98-100](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L98-L100)</ins>
</pre>
...
{:ns "clojure.set",
 ...
 :source {:code "(defn map-invert\n  [m] (reduce (fn [m [k v]] (assoc m v k)) {} m))",
          ...
          :lines [98 100],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L98-L100"},
