...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[dom.cljs:136-140](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/dom.cljs#L136-L140)</ins>
</pre>
...
{:full-name "clojure.browser.dom/set-properties",
 ...
 :source {:code "(defn set-properties\n  [e m]\n  (gdom/setProperties (ensure-element e)\n                      (apply gobject/create (interleave (keys m) (vals m)))))",
          ...
          :lines [136 140],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/dom.cljs#L136-L140"},
