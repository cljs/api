...
└── src
    └── cljs
        └── clojure
            └── <ins>[zip.cljs:189-192](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L189-L192)</ins>
</pre>
...
{:ns "clojure.zip",
 ...
 :source {:code "(defn edit\n  [loc f & args]\n    (replace loc (apply f (node loc) args)))",
          ...
          :lines [189 192],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L189-L192"},
