...
{:return-type boolean,
 ...
 :shadowed-sources ({:code "(defmacro true? [x]\n  (bool-expr (list 'js* \"~{} === true\" x)))",
                     ...
                     :lines [199 200],
                     :link "https://github.com/clojure/clojurescript/blob/r1503/src/clj/cljs/core.clj#L199-L200"}),
 :history [["+" "0.0-927"]],
 :type "function",
 ...
 :source {:code "(defn ^boolean true?\n  [x] (cljs.core/true? x))",
          ...
          :lines [989 991],
          :link "https://github.com/clojure/clojurescript/blob/r1503/src/cljs/cljs/core.cljs#L989-L991"},
