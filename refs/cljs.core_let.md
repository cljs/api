...
└── src
    └── clj
        └── cljs
            └── <ins>[core.clj:127-137](https://github.com/clojure/clojurescript/blob/r1834/src/clj/cljs/core.clj#L127-L137)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defmacro let\n  [bindings & body]\n  (assert-args\n     (vector? bindings) \"a vector for its binding\"\n     (even? (count bindings)) \"an even number of forms in binding vector\")\n  `(let* ~(destructure bindings) ~@body))",
          ...
          :lines [127 137],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/clj/cljs/core.clj#L127-L137"},
