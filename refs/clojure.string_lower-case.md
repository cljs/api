...
└── src
    └── cljs
        └── clojure
            └── <ins>[string.cljs:58-61](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/string.cljs#L58-L61)</ins>
</pre>
...
{:ns "clojure.string",
 ...
 :source {:code "(defn lower-case\n  [s]\n  (.toLowerCase s))",
          ...
          :lines [58 61],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/string.cljs#L58-L61"},
