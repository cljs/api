...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[repl.cljs:21-21](https://github.com/clojure/clojurescript/blob/r993/src/cljs/clojure/browser/repl.cljs#L21-L21)</ins>
</pre>
...
{:full-name "clojure.browser.repl/xpc-connection",
 ...
 :source {:code "(def xpc-connection (atom nil))",
          ...
          :lines [21 21],
          :link "https://github.com/clojure/clojurescript/blob/r993/src/cljs/clojure/browser/repl.cljs#L21-L21"},
