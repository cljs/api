...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:6147-6147](https://github.com/clojure/clojurescript/blob/r1424/src/cljs/cljs/core.cljs#L6147-L6147)</ins>
</pre>
...
{:full-name "cljs.core/*print-readably*",
 ...
 :source {:code "(def *print-readably* true)",
          ...
          :lines [6147 6147],
          :link "https://github.com/clojure/clojurescript/blob/r1424/src/cljs/cljs/core.cljs#L6147-L6147"},
