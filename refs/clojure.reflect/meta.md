...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/reflect.cljs#L25-L31):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[reflect.cljs:25-31](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/reflect.cljs#L25-L31)</ins>
</pre>
