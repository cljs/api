...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[net.cljs:21-21](https://github.com/clojure/clojurescript/blob/r1586/src/cljs/clojure/browser/net.cljs#L21-L21)</ins>
</pre>
...
{:full-name "clojure.browser.net/*timeout*",
 ...
 :source {:code "(def *timeout* 10000)",
          ...
          :lines [21 21],
          :link "https://github.com/clojure/clojurescript/blob/r1586/src/cljs/clojure/browser/net.cljs#L21-L21"},
