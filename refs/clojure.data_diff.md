...
└── src
    └── cljs
        └── clojure
            └── <ins>[data.cljs:144-161](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/data.cljs#L144-L161)</ins>
</pre>
...
{:ns "clojure.data",
 ...
 :source {:code "(defn diff\n  [a b]\n  (if (= a b)\n    [nil nil a]\n    (if (= (equality-partition a) (equality-partition b))\n      (diff-similar a b)\n      (atom-diff a b))))",
          ...
          :lines [144 161],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/data.cljs#L144-L161"},
