...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:62-69](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/event.cljs#L62-L69)</ins>
</pre>
...
{:full-name "clojure.browser.event/unlisten",
 ...
 :source {:code "(defn unlisten\n  ([src type fn]\n     (unlisten src type fn false))\n  ([src type fn capture?]\n     (goog.events/unlisten src\n                           (get (event-types src) type type)\n                           fn\n                           capture?)))",
          ...
          :lines [62 69],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/event.cljs#L62-L69"},
