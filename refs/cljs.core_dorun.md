...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:6418-6429](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6418-L6429)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn dorun\n  ([coll]\n   (when (seq coll)\n     (recur (next coll))))\n  ([n coll]\n   (when (and (seq coll) (pos? n))\n     (recur (dec n) (next coll)))))",
          ...
          :lines [6418 6429],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6418-L6429"},
