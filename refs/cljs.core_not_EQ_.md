...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:2451-2456](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L2451-L2456)</ins>
</pre>
...
{:return-type boolean,
 ...
 :source {:code "(defn ^boolean not=\n  ([x] false)\n  ([x y] (not (= x y)))\n  ([x y & more]\n   (not (apply = x y more))))",
          ...
          :lines [2451 2456],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L2451-L2456"},
