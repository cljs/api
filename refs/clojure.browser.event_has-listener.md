...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:94-94](https://github.com/clojure/clojurescript/blob/r1211/src/cljs/clojure/browser/event.cljs#L94-L94)</ins>
</pre>
...
{:full-name "clojure.browser.event/has-listener",
 ...
 :source {:code "(defn has-listener [obj opt_type opt_capture])",
          ...
          :lines [94 94],
          :link "https://github.com/clojure/clojurescript/blob/r1211/src/cljs/clojure/browser/event.cljs#L94-L94"},
