...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:90-90](https://github.com/clojure/clojurescript/blob/r1806/src/cljs/clojure/browser/event.cljs#L90-L90)</ins>
</pre>
...
{:full-name "clojure.browser.event/all-listeners",
 ...
 :source {:code "(defn all-listeners [obj type capture])",
          ...
          :lines [90 90],
          :link "https://github.com/clojure/clojurescript/blob/r1806/src/cljs/clojure/browser/event.cljs#L90-L90"},
