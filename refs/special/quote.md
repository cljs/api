...
Parser code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/clojure/cljs/analyzer.cljc#L1532-L1534):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[analyzer.cljc:1532-1534](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/clojure/cljs/analyzer.cljc#L1532-L1534)</ins>
</pre>
