...
└── src
    └── cljs
        └── clojure
            └── <ins>[zip.cljs:87-90](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L87-L90)</ins>
</pre>
...
{:ns "clojure.zip",
 ...
 :source {:code "(defn lefts\n  [loc]\n    (seq (:l (loc 1))))",
          ...
          :lines [87 90],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L87-L90"},
