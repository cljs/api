...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/clojure/core/reducers.cljs#L79-L94):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── core
                    └── <ins>[reducers.cljs:79-94](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/clojure/core/reducers.cljs#L79-L94)</ins>
</pre>
