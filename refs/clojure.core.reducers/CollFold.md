...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/clojure/core/reducers.cljs#L46-L47):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── core
                    └── <ins>[reducers.cljs:46-47](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/clojure/core/reducers.cljs#L46-L47)</ins>
</pre>
