...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/clojure/core/reducers.cljs#L66-L77):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── core
                    └── <ins>[reducers.cljs:66-77](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/clojure/core/reducers.cljs#L66-L77)</ins>
</pre>
