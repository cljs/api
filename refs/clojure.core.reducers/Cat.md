...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/core/reducers.cljs#L193-L211):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── core
                    └── <ins>[reducers.cljs:193-211](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/core/reducers.cljs#L193-L211)</ins>
</pre>
