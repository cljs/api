...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/core/reducers.cljs#L164-L176):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── core
                    └── <ins>[reducers.cljs:164-176](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/core/reducers.cljs#L164-L176)</ins>
</pre>
