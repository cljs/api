...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:6327-6334](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6327-L6334)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn range\n  ([] (range 0 js/Number.MAX_VALUE 1))\n  ([end] (range 0 end 1))\n  ([start end] (range start end 1))\n  ([start end step] (Range. nil start end step nil)))",
          ...
          :lines [6327 6334],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6327-L6334"},
