...
└── src
    └── cljs
        └── clojure
            └── <ins>[walk.cljs:37-48](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/walk.cljs#L37-L48)</ins>
</pre>
...
{:ns "clojure.walk",
 ...
 :source {:code "(defn walk\n  [inner outer form]\n  (cond\n   (seq? form) (outer (doall (map inner form)))\n   (coll? form) (outer (into (empty form) (map inner form)))\n   :else (outer form)))",
          ...
          :lines [37 48],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/walk.cljs#L37-L48"},
