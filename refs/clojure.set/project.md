...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/set.cljs#L67-L70):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[set.cljs:67-70](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/set.cljs#L67-L70)</ins>
</pre>
