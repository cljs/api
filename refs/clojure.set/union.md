...
<samp>(union)</samp><br>
<samp>(union s1)</samp><br>
<samp>(union s1 s2)</samp><br>
<samp>(union s1 s2 & sets)</samp><br>
...
{:description "Return a set that is the union of the input sets.",
 ...
 :source {:code "(defn union\n  ([] #{})\n  ([s1] s1)\n  ([s1 s2]\n     (if (< (count s1) (count s2))\n       (reduce conj s2 s1)\n       (reduce conj s1 s2)))\n  ([s1 s2 & sets]\n     (let [bubbled-sets (bubble-max-key count (conj sets s2 s1))]\n       (reduce into (first bubbled-sets) (rest bubbled-sets)))))",
          ...
          :lines [19 29],
          :url "https://github.com/clojure/clojurescript/blob/r1.8.51/src/main/cljs/clojure/set.cljs#L19-L29"},
 :usage ["(union)"
         "(union s1)"
         "(union s1 s2)"
         "(union s1 s2 & sets)"],
 ...
 :cljsdoc-url "https://github.com/cljsinfo/cljs-api-docs/blob/master/cljsdoc/clojure.set/union.cljsdoc"}
