...
└── src
    └── cljs
        └── clojure
            └── <ins>[data.cljs:75-77](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/data.cljs#L75-L77)</ins>
</pre>
...
{:ns "clojure.data",
 ...
 :source {:code "(defprotocol EqualityPartition\n  \"Implementation detail. Subject to change.\"\n  (equality-partition [x] \"Implementation detail. Subject to change.\"))",
          ...
          :lines [75 77],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/data.cljs#L75-L77"},
