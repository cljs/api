...
└── src
    └── cljs
        └── clojure
            └── <ins>[string.cljs:133-136](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/string.cljs#L133-L136)</ins>
</pre>
...
{:ns "clojure.string",
 ...
 :source {:code "(defn blank?\n  [s]\n  (gstring/isEmptySafe s))",
          ...
          :lines [133 136],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/string.cljs#L133-L136"},
