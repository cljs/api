...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:1747-1751](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L1747-L1751)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn subs\n  ([s start] (.substring s start))\n  ([s start end] (.substring s start end)))",
          ...
          :lines [1747 1751],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L1747-L1751"},
