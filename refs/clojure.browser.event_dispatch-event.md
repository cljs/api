...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:75-77](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/event.cljs#L75-L77)</ins>
</pre>
...
{:full-name "clojure.browser.event/dispatch-event",
 ...
 :source {:code "(defn dispatch-event\n  [src event]\n  (goog.events/dispatchEvent src event))",
          ...
          :lines [75 77],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/event.cljs#L75-L77"},
