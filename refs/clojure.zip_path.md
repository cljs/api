...
└── src
    └── cljs
        └── clojure
            └── <ins>[zip.cljs:82-85](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L82-L85)</ins>
</pre>
...
{:ns "clojure.zip",
 ...
 :source {:code "(defn path\n  [loc]\n    (:pnodes (loc 1)))",
          ...
          :lines [82 85],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L82-L85"},
