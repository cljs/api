...
└── src
    └── clj
        └── cljs
            └── <ins>[core.clj:1220-1232](https://github.com/clojure/clojurescript/blob/r1834/src/clj/cljs/core.clj#L1220-L1232)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defmacro dotimes\n  [bindings & body]\n  (let [i (first bindings)\n        n (second bindings)]\n    `(let [n# ~n]\n       (loop [~i 0]\n         (when (< ~i n#)\n           ~@body\n           (recur (inc ~i)))))))",
          ...
          :lines [1220 1232],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/clj/cljs/core.clj#L1220-L1232"},
