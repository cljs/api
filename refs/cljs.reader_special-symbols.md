...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:312-317](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/reader.cljs#L312-L317)</ins>
</pre>
...
{:full-name "cljs.reader/special-symbols",
 ...
 :source {:code "(defn special-symbols [t not-found]\n  (cond\n   (identical? t \"nil\") nil\n   (identical? t \"true\") true\n   (identical? t \"false\") false\n   :else not-found))",
          ...
          :lines [312 317],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/reader.cljs#L312-L317"},
