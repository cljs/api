...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.8.34/src/main/cljs/clojure/string.cljs#L250-L253):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[string.cljs:250-253](https://github.com/clojure/clojurescript/blob/r1.8.34/src/main/cljs/clojure/string.cljs#L250-L253)</ins>
</pre>
...
{:return-type boolean,
 ...
 :clj-symbol "clojure.string/ends-with?",
