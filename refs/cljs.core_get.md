...
{:ns "cljs.core",
 ...
 :shadowed-sources ({:code "(defmacro get\n  ([coll k]\n     `(-lookup ~coll ~k nil))\n  ([coll k not-found]\n     `(-lookup ~coll ~k ~not-found)))",
                     ...
                     :lines [358 362],
                     :link "https://github.com/clojure/clojurescript/blob/r1552/src/clj/cljs/core.clj#L358-L362"}),
 :history [["+" "0.0-927"]],
 :type "function",
 ...
 :source {:code "(defn get\n  ([o k]\n     (-lookup o k))\n  ([o k not-found]\n     (-lookup o k not-found)))",
          ...
          :lines [831 836],
          :link "https://github.com/clojure/clojurescript/blob/r1552/src/cljs/cljs/core.cljs#L831-L836"},
