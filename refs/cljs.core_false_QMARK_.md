...
{:return-type boolean,
 ...
 :shadowed-sources ({:code "(defmacro false? [x]\n  (bool-expr (list 'js* \"~{} === false\" x)))",
                     ...
                     :lines [202 203],
                     :link "https://github.com/clojure/clojurescript/blob/r1450/src/clj/cljs/core.clj#L202-L203"}),
 :history [["+" "0.0-927"]],
 :type "function",
 ...
 :source {:code "(defn ^boolean false?\n  [x] (cljs.core/false? x))",
          ...
          :lines [952 954],
          :link "https://github.com/clojure/clojurescript/blob/r1450/src/cljs/cljs/core.cljs#L952-L954"},
