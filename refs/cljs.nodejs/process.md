...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/nodejs.cljs#L16):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[nodejs.cljs:16](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/nodejs.cljs#L16)</ins>
</pre>
