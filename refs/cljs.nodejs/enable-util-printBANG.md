...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/nodejs.cljs#L18-L26):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[nodejs.cljs:18-26](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/nodejs.cljs#L18-L26)</ins>
</pre>
