...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:6944-6952](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6944-L6952)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn gensym\n  ([] (gensym \"G__\"))\n  ([prefix-string]\n     (when (nil? gensym_counter)\n       (set! gensym_counter (atom 0)))\n     (symbol (str prefix-string (swap! gensym_counter inc)))))",
          ...
          :lines [6944 6952],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6944-L6952"},
