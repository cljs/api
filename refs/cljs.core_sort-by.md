...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:1281-1289](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L1281-L1289)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn sort-by\n  ([keyfn coll]\n   (sort-by keyfn compare coll))\n  ([keyfn comp coll]\n     (sort (fn [x y] ((fn->comparator comp) (keyfn x) (keyfn y))) coll)))",
          ...
          :lines [1281 1289],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L1281-L1289"},
