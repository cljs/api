...
└── src
    └── cljs
        └── cljs
            └── <ins>[nodejs.cljs:7-7](https://github.com/clojure/clojurescript/blob/r1450/src/cljs/cljs/nodejs.cljs#L7-L7)</ins>
</pre>
...
{:full-name "cljs.nodejs/require",
 ...
 :source {:code "(def require (js* \"require\"))",
          ...
          :lines [7 7],
          :link "https://github.com/clojure/clojurescript/blob/r1450/src/cljs/cljs/nodejs.cljs#L7-L7"},
