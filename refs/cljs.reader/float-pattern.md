...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/cljs/reader.cljs#L100):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:100](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/cljs/reader.cljs#L100)</ins>
</pre>
