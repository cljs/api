...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.8.34/src/main/cljs/cljs/reader.cljs#L98):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:98](https://github.com/clojure/clojurescript/blob/r1.8.34/src/main/cljs/cljs/reader.cljs#L98)</ins>
</pre>
