...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/cljs/reader.cljs#L250-L258):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:250-258](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/cljs/reader.cljs#L250-L258)</ins>
</pre>
