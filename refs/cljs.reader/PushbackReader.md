...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/cljs/reader.cljs#L13-L16):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:13-16](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/cljs/reader.cljs#L13-L16)</ins>
</pre>
