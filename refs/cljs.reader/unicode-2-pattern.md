...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/reader.cljs#L181):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:181](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/reader.cljs#L181)</ins>
</pre>
