...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/reader.cljs#L337-L350):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:337-350](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/reader.cljs#L337-L350)</ins>
</pre>
