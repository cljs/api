...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/reader.cljs#L225-L238):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:225-238](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/cljs/reader.cljs#L225-L238)</ins>
</pre>
