...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/cljs/reader.cljs#L381-L384):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[reader.cljs:381-384](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/cljs/reader.cljs#L381-L384)</ins>
</pre>
