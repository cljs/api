...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:100-100](https://github.com/clojure/clojurescript/blob/r1513/src/cljs/cljs/reader.cljs#L100-L100)</ins>
</pre>
...
{:full-name "cljs.reader/ratio-pattern",
 ...
 :source {:code "(def ratio-pattern (re-pattern \"([-+]?[0-9]+)/([0-9]+)\"))",
          ...
          :lines [100 100],
          :link "https://github.com/clojure/clojurescript/blob/r1513/src/cljs/cljs/reader.cljs#L100-L100"},
