...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:7073-7087](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L7073-L7087)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn trampoline\n  ([f]\n     (let [ret (f)]\n       (if (fn? ret)\n         (recur ret)\n         ret)))\n  ([f & args]\n     (trampoline #(apply f args))))",
          ...
          :lines [7073 7087],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L7073-L7087"},
