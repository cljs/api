...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[repl.cljs:55-55](https://github.com/clojure/clojurescript/blob/r1513/src/cljs/clojure/browser/repl.cljs#L55-L55)</ins>
</pre>
...
{:full-name "clojure.browser.repl/order",
 ...
 :source {:code "(def order (atom 0))",
          ...
          :lines [55 55],
          :link "https://github.com/clojure/clojurescript/blob/r1513/src/cljs/clojure/browser/repl.cljs#L55-L55"},
