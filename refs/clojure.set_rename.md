...
└── src
    └── cljs
        └── clojure
            └── <ins>[set.cljs:83-86](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L83-L86)</ins>
</pre>
...
{:ns "clojure.set",
 ...
 :source {:code "(defn rename\n  [xrel kmap]\n    (set (map #(rename-keys % kmap) xrel)))",
          ...
          :lines [83 86],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/set.cljs#L83-L86"},
