...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/cljs/test.cljs#L496-L502):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[test.cljs:496-502](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/cljs/test.cljs#L496-L502)</ins>
</pre>
