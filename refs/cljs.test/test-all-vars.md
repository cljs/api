...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/cljs/test.clj#L333-L340):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[test.clj:333-340](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/cljs/cljs/test.clj#L333-L340)</ins>
</pre>
