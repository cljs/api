...
└── src
    └── cljs
        └── clojure
            └── <ins>[zip.cljs:76-80](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L76-L80)</ins>
</pre>
...
{:ns "clojure.zip",
 ...
 :source {:code "(defn make-node\n  [loc node children]\n    ((:zip/make-node (meta loc)) node children))",
          ...
          :lines [76 80],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L76-L80"},
