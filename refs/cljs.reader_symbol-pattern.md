...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:98-98](https://github.com/clojure/clojurescript/blob/r1006/src/cljs/cljs/reader.cljs#L98-L98)</ins>
</pre>
...
{:full-name "cljs.reader/symbol-pattern",
 ...
 :source {:code "(def symbol-pattern (re-pattern \"[:]?([^0-9/].*/)?([^0-9/][^/]*)\"))",
          ...
          :lines [98 98],
          :link "https://github.com/clojure/clojurescript/blob/r1006/src/cljs/cljs/reader.cljs#L98-L98"},
