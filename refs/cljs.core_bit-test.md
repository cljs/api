...
{:ns "cljs.core",
 ...
 :shadowed-sources ({:code "(defmacro bit-test [x n]\n  (list 'js* \"((~{} & (1 << ~{})) != 0)\" x n))",
                     ...
                     :lines [326 327],
                     :link "https://github.com/clojure/clojurescript/blob/r1503/src/clj/cljs/core.clj#L326-L327"}),
 :history [["+" "0.0-927"]],
 :type "function",
 ...
 :source {:code "(defn bit-test\n  [x n]\n  (cljs.core/bit-test x n))",
          ...
          :lines [1374 1377],
          :link "https://github.com/clojure/clojurescript/blob/r1503/src/cljs/cljs/core.cljs#L1374-L1377"},
