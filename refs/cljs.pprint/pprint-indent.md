...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.8.34/src/main/cljs/cljs/pprint.cljs#L852-L863):
...
└── src
    └── main
        └── cljs
            └── cljs
                └── <ins>[pprint.cljs:852-863](https://github.com/clojure/clojurescript/blob/r1.8.34/src/main/cljs/cljs/pprint.cljs#L852-L863)</ins>
</pre>
