...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[repl.cljs:57-58](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/repl.cljs#L57-L58)</ins>
</pre>
...
{:full-name "clojure.browser.repl/wrap-message",
 ...
 :source {:code "(defn wrap-message [t data]\n  (pr-str {:type t :content data :order (swap! order inc)}))",
          ...
          :lines [57 58],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/repl.cljs#L57-L58"},
