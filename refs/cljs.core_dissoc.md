...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:966-976](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L966-L976)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn dissoc\n  ([coll] coll)\n  ([coll k]\n     (-dissoc coll k))\n  ([coll k & ks]\n     (let [ret (dissoc coll k)]\n       (if ks\n         (recur ret (first ks) (next ks))\n         ret))))",
          ...
          :lines [966 976],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L966-L976"},
