...
└── src
    └── cljs
        └── cljs
            └── <ins>[nodejs.cljs:8-8](https://github.com/clojure/clojurescript/blob/r1586/src/cljs/cljs/nodejs.cljs#L8-L8)</ins>
</pre>
...
{:full-name "cljs.nodejs/process",
 ...
 :source {:code "(def process (js* \"process\"))",
          ...
          :lines [8 8],
          :link "https://github.com/clojure/clojurescript/blob/r1586/src/cljs/cljs/nodejs.cljs#L8-L8"},
