...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:6909-6931](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6909-L6931)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn add-watch\n  [iref key f]\n  (-add-watch iref key f))",
          ...
          :lines [6909 6931],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6909-L6931"},
