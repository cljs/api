...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:71-73](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/event.cljs#L71-L73)</ins>
</pre>
...
{:full-name "clojure.browser.event/unlisten-by-key",
 ...
 :source {:code "(defn unlisten-by-key\n  [key]\n  (goog.events/unlistenByKey key))",
          ...
          :lines [71 73],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/event.cljs#L71-L73"},
