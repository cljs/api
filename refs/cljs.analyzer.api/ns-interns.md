...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/clojure/cljs/analyzer/api.clj#L169-L178):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── analyzer
                    └── <ins>[api.clj:169-178](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/clojure/cljs/analyzer/api.clj#L169-L178)</ins>
</pre>
