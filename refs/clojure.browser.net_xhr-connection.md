...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[net.cljs:83-86](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/net.cljs#L83-L86)</ins>
</pre>
...
{:full-name "clojure.browser.net/xhr-connection",
 ...
 :source {:code "(defn xhr-connection\n  []\n  (goog.net.XhrIo.))",
          ...
          :lines [83 86],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/net.cljs#L83-L86"},
