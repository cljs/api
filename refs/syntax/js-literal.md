...
Reader code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.145/src/main/clojure/cljs/tagged_literals.cljc#L62-L77):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[tagged_literals.cljc:62-77](https://github.com/clojure/clojurescript/blob/r1.7.145/src/main/clojure/cljs/tagged_literals.cljc#L62-L77)</ins>
</pre>
-->
