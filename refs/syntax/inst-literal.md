...
Reader code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/clojure/cljs/tagged_literals.cljc#L36-L43):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[tagged_literals.cljc:36-43](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/clojure/cljs/tagged_literals.cljc#L36-L43)</ins>
</pre>
-->

---
Reader table @ [github](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/clojure/cljs/tagged_literals.cljc#L79-L83):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[tagged_literals.cljc:79-83](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/clojure/cljs/tagged_literals.cljc#L79-L83)</ins>
</pre>
-->
