...
Reader code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.122/src/main/clojure/cljs/tagged_literals.cljc#L36-L43):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[tagged_literals.cljc:36-43](https://github.com/clojure/clojurescript/blob/r1.7.122/src/main/clojure/cljs/tagged_literals.cljc#L36-L43)</ins>
</pre>
-->
