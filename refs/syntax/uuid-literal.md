...
Reader code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/clojure/cljs/tagged_literals.cljc#L16-L23):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[tagged_literals.cljc:16-23](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/clojure/cljs/tagged_literals.cljc#L16-L23)</ins>
</pre>
-->

---
Reader table @ [github](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/clojure/cljs/tagged_literals.cljc#L79-L83):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[tagged_literals.cljc:79-83](https://github.com/clojure/clojurescript/blob/r1.7.170/src/main/clojure/cljs/tagged_literals.cljc#L79-L83)</ins>
</pre>
-->
