...
Reader code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.145/src/main/clojure/cljs/tagged_literals.cljc#L16-L23):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[tagged_literals.cljc:16-23](https://github.com/clojure/clojurescript/blob/r1.7.145/src/main/clojure/cljs/tagged_literals.cljc#L16-L23)</ins>
</pre>
-->
