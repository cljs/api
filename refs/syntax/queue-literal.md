...
Reader code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/clojure/cljs/tagged_literals.cljc#L5-L13):
...
└── src
    └── main
        └── clojure
            └── cljs
                └── <ins>[tagged_literals.cljc:5-13](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/clojure/cljs/tagged_literals.cljc#L5-L13)</ins>
</pre>
-->
