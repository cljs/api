...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/clojure/browser/net.cljs#L30-L42):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── browser
                    └── <ins>[net.cljs:30-42](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/clojure/browser/net.cljs#L30-L42)</ins>
</pre>
