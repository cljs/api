...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/clojure/browser/net.cljs#L81-L84):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── browser
                    └── <ins>[net.cljs:81-84](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/clojure/browser/net.cljs#L81-L84)</ins>
</pre>
