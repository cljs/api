...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/clojure/zip.cljs#L60-L62):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[zip.cljs:60-62](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/clojure/zip.cljs#L60-L62)</ins>
</pre>
