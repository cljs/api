...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/clojure/zip.cljs#L174-L181):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[zip.cljs:174-181](https://github.com/clojure/clojurescript/blob/r1.7.166/src/main/cljs/clojure/zip.cljs#L174-L181)</ins>
</pre>
