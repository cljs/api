...
{:return-type boolean,
 ...
 :shadowed-sources ({:code "(defmacro nil? [x]\n  `(coercive-= ~x nil))",
                     ...
                     :lines [184 185],
                     :link "https://github.com/clojure/clojurescript/blob/r1535/src/clj/cljs/core.clj#L184-L185"}),
 :history [["+" "0.0-927"]],
 :type "function",
 ...
 :source {:code "(defn ^boolean nil?\n  [x]\n  (coercive-= x nil))",
          ...
          :lines [48 51],
          :link "https://github.com/clojure/clojurescript/blob/r1535/src/cljs/cljs/core.cljs#L48-L51"},
