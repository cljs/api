...
└── src
    └── cljs
        └── clojure
            └── <ins>[walk.cljs:64-70](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/walk.cljs#L64-L70)</ins>
</pre>
...
{:ns "clojure.walk",
 ...
 :source {:code "(defn keywordize-keys\n  [m]\n  (let [f (fn [[k v]] (if (string? k) [(keyword k) v] [k v]))]\n    ;; only apply to maps\n    (postwalk (fn [x] (if (map? x) (into {} (map f x)) x)) m)))",
          ...
          :lines [64 70],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/walk.cljs#L64-L70"},
