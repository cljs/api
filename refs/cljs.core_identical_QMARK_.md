...
{:return-type boolean,
 ...
 :shadowed-sources ({:code "(defmacro identical? [a b]\n  (bool-expr (list 'js* \"(~{} === ~{})\" a b)))",
                     ...
                     :lines [208 209],
                     :link "https://github.com/clojure/clojurescript/blob/r1586/src/clj/cljs/core.clj#L208-L209"}),
 :history [["+" "0.0-927"]],
 :type "function",
 ...
 :source {:code "(defn ^boolean identical?\n  [x y]\n  (cljs.core/identical? x y))",
          ...
          :lines [43 46],
          :link "https://github.com/clojure/clojurescript/blob/r1586/src/cljs/cljs/core.cljs#L43-L46"},
