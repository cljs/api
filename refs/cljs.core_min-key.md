...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:6194-6199](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6194-L6199)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn min-key\n  ([k x] x)\n  ([k x y] (if (< (k x) (k y)) x y))\n  ([k x y & more]\n     (reduce #(min-key k %1 %2) (min-key k x y) more)))",
          ...
          :lines [6194 6199],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6194-L6199"},
