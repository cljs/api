...
└── src
    └── cljs
        └── clojure
            └── <ins>[zip.cljs:64-67](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L64-L67)</ins>
</pre>
...
{:ns "clojure.zip",
 ...
 :source {:code "(defn branch?\n  [loc]\n    ((:zip/branch? (meta loc)) (node loc)))",
          ...
          :lines [64 67],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L64-L67"},
