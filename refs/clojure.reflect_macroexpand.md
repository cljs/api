...
└── src
    └── cljs
        └── clojure
            └── <ins>[reflect.cljs:32-36](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/reflect.cljs#L32-L36)</ins>
</pre>
...
{:full-name "clojure.reflect/macroexpand",
 ...
 :source {:code "(defn macroexpand\n  [form]\n  (query-reflection (str \"macroform=\" (js/encodeURIComponent (str form))) println))",
          ...
          :lines [32 36],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/reflect.cljs#L32-L36"},
