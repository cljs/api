...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/clojure/walk.cljs#L52-L58):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[walk.cljs:52-58](https://github.com/clojure/clojurescript/blob/r1.7.189/src/main/cljs/clojure/walk.cljs#L52-L58)</ins>
</pre>
