...
Source code @ [github](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/walk.cljs#L37-L50):
...
└── src
    └── main
        └── cljs
            └── clojure
                └── <ins>[walk.cljs:37-50](https://github.com/clojure/clojurescript/blob/r1.7.228/src/main/cljs/clojure/walk.cljs#L37-L50)</ins>
</pre>
