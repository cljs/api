...
└── src
    └── cljs
        └── clojure
            └── <ins>[zip.cljs:232-235](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L232-L235)</ins>
</pre>
...
{:ns "clojure.zip",
 ...
 :source {:code "(defn end?\n  [loc]\n    (= :end (loc 1)))",
          ...
          :lines [232 235],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/zip.cljs#L232-L235"},
