...
{:ns "cljs.core",
 ...
 :shadowed-sources ({:code "(defmacro bit-or\n  ([x y] (list 'js* \"(~{} | ~{})\" x y))\n  ([x y & more] `(bit-or (bit-or ~x ~y) ~@more)))",
                     ...
                     :lines [308 310],
                     :link "https://github.com/clojure/clojurescript/blob/r1552/src/clj/cljs/core.clj#L308-L310"}),
 :history [["+" "0.0-927"]],
 :type "function",
 ...
 :source {:code "(defn bit-or\n  [x y] (cljs.core/bit-or x y))",
          ...
          :lines [1374 1376],
          :link "https://github.com/clojure/clojurescript/blob/r1552/src/cljs/cljs/core.cljs#L1374-L1376"},
