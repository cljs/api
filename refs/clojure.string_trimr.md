...
└── src
    └── cljs
        └── clojure
            └── <ins>[string.cljs:116-119](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/string.cljs#L116-L119)</ins>
</pre>
...
{:ns "clojure.string",
 ...
 :source {:code "(defn trimr\n    [s]\n    (gstring/trimRight s))",
          ...
          :lines [116 119],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/string.cljs#L116-L119"},
