...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:89-89](https://github.com/clojure/clojurescript/blob/r1820/src/cljs/clojure/browser/event.cljs#L89-L89)</ins>
</pre>
...
{:full-name "clojure.browser.event/get-listener",
 ...
 :source {:code "(defn get-listener [src type listener opt_capt opt_handler])",
          ...
          :lines [89 89],
          :link "https://github.com/clojure/clojurescript/blob/r1820/src/cljs/clojure/browser/event.cljs#L89-L89"},
