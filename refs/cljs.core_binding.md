...
└── src
    └── clj
        └── cljs
            └── <ins>[core.clj:894-905](https://github.com/clojure/clojurescript/blob/r1834/src/clj/cljs/core.clj#L894-L905)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defmacro binding\n  [bindings & body]\n  (let [names (take-nth 2 bindings)]\n    (cljs.analyzer/confirm-bindings &env names)\n    `(with-redefs ~bindings ~@body)))",
          ...
          :lines [894 905],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/clj/cljs/core.clj#L894-L905"},
