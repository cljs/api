...
└── src
    └── cljs
        └── clojure
            └── browser
                └── <ins>[event.cljs:17-18](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/event.cljs#L17-L18)</ins>
</pre>
...
{:ns "clojure.browser.event",
 ...
 :source {:code "(defprotocol EventType\n  (event-types [this]))",
          ...
          :lines [17 18],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/browser/event.cljs#L17-L18"},
