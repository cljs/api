...
└── src
    └── cljs
        └── cljs
            └── <ins>[reader.cljs:99-99](https://github.com/clojure/clojurescript/blob/r1443/src/cljs/cljs/reader.cljs#L99-L99)</ins>
</pre>
...
{:full-name "cljs.reader/int-pattern",
 ...
 :source {:code "(def int-pattern (re-pattern \"([-+]?)(?:(0)|([1-9][0-9]*)|0[xX]([0-9A-Fa-f]+)|0([0-7]+)|([1-9][0-9]?)[rR]([0-9A-Za-z]+)|0[0-9]+)(N)?\"))",
          ...
          :lines [99 99],
          :link "https://github.com/clojure/clojurescript/blob/r1443/src/cljs/cljs/reader.cljs#L99-L99"},
