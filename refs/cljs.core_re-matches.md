...
└── src
    └── cljs
        └── cljs
            └── <ins>[core.cljs:6450-6457](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6450-L6457)</ins>
</pre>
...
{:ns "cljs.core",
 ...
 :source {:code "(defn re-matches\n  [re s]\n  (let [matches (.exec re s)]\n    (when (= (first matches) s)\n      (if (== (count matches) 1)\n        (first matches)\n        (vec matches)))))",
          ...
          :lines [6450 6457],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/cljs/core.cljs#L6450-L6457"},
