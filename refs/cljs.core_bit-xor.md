...
{:ns "cljs.core",
 ...
 :shadowed-sources ({:code "(defmacro bit-xor\n  ([x y] (list 'js* \"(~{} ^ ~{})\" x y))\n  ([x y & more] `(bit-xor (bit-xor ~x ~y) ~@more)))",
                     ...
                     :lines [312 314],
                     :link "https://github.com/clojure/clojurescript/blob/r1450/src/clj/cljs/core.clj#L312-L314"}),
 :history [["+" "0.0-927"]],
 :type "function",
 ...
 :source {:code "(defn bit-xor\n  [x y] (cljs.core/bit-xor x y))",
          ...
          :lines [1317 1319],
          :link "https://github.com/clojure/clojurescript/blob/r1450/src/cljs/cljs/core.cljs#L1317-L1319"},
