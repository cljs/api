...
└── src
    └── cljs
        └── clojure
            └── <ins>[walk.cljs:80-86](https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/walk.cljs#L80-L86)</ins>
</pre>
...
{:ns "clojure.walk",
 ...
 :source {:code "(defn prewalk-replace\n  [smap form]\n  (prewalk (fn [x] (if (contains? smap x) (smap x) x)) form))",
          ...
          :lines [80 86],
          :link "https://github.com/clojure/clojurescript/blob/r1834/src/cljs/clojure/walk.cljs#L80-L86"},
