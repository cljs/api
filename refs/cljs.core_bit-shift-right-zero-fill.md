...
{:ns "cljs.core",
 ...
 :shadowed-sources ({:code "(defmacro bit-shift-right-zero-fill [x n]\n  (list 'js* \"(~{} >>> ~{})\" x n))",
                     ...
                     :lines [335 336],
                     :link "https://github.com/clojure/clojurescript/blob/r1449/src/clj/cljs/core.clj#L335-L336"}),
 :history [["+" "0.0-1211"]],
 :type "function",
 ...
 :source {:code "(defn bit-shift-right-zero-fill\n  [x n] (cljs.core/bit-shift-right-zero-fill x n))",
          ...
          :lines [1365 1367],
          :link "https://github.com/clojure/clojurescript/blob/r1449/src/cljs/cljs/core.cljs#L1365-L1367"},
