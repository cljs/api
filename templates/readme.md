...
curated descriptions, examples, and cross-refs for each symbol.

> __TEMPORARY__: This will live on a proper website for ClojureScript soon.  For
> now, consider this a public view of the API docs as we ready them for the final
> website.
