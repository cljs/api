...
[this project](https://github.com/cljsinfo/api-refs), and supplemented by
curated descriptions, examples, and cross-refs for each symbol (in-progress).

__[Offline version available here](https://github.com/cljsinfo/api-refs#offline-docset-for-dash)__
